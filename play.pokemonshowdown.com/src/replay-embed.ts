...
requireScript(`${replayAssetBase}js/lib/ps-polyfill.js`);
requireScript(`${replayAssetBase}config/config.js?a7`);
requireScript(`${replayAssetBase}js/lib/jquery-1.11.0.min.js`);
requireScript(`${replayAssetBase}js/lib/html-sanitizer-minified.js`);
requireScript(`${replayAssetBase}js/battle-sound.js`);
requireScript(`${replayAssetBase}js/battledata.js?a7`);
requireScript(`${replayAssetBase}data/pokedex-mini.js?a7`);
requireScript(`${replayAssetBase}data/pokedex-mini-bw.js?a7`);
requireScript(`${replayAssetBase}data/graphics.js?a7`);
requireScript(`${replayAssetBase}data/pokedex.js?a7`);
requireScript(`${replayAssetBase}data/moves.js?a7`);
requireScript(`${replayAssetBase}data/abilities.js?a7`);
requireScript(`${replayAssetBase}data/items.js?a7`);
requireScript(`${replayAssetBase}data/teambuilder-tables.js?a7`);
requireScript(`${replayAssetBase}js/battle-tooltips.js?a7`);
requireScript(`${replayAssetBase}js/battle.js?a7`);
